                        ...
                        <div class="card" style="height: 95%;">
                            <div class="card-body">
                                ...
                                @endif" class="img-circle" width="150" />
                                    ...
                                    <h6 class="card-subtitle">{{ $data->contact_number_1 }}7</h6>
                                ...
                                <div class="tab-pane active" id="settings" role="tabpanel">
                                    ...
                                    @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" placeholder="Enter First Name" class="form-control form-control-line" value="{{ $data->prospect_first_name }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" placeholder="Enter Last Name" class="form-control form-control-line" value="{{ $data->prospect_last_name }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" placeholder="Enter Email" class="form-control form-control-line" value="{{ $data->prospect_email }}" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" placeholder="Enter Phone No" class="form-control form-control-line" value="{{ $data->contact_number_1 }}" readonly>
                                                </div>
                                            </div>

            ...
            <div class="card-body lhs">
               <form method='post' action="{{ route('employee.update_lhs_report') }}">
                  ...
                  <div class="form-body ">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                             ...
                             <?php if(isset($_GET["status"])){ 
                              ...
                              <input type="text" id="prospect_first_name" name='prospect_first_name'class="form-control read-only-input" readonly placeholder="Enter Contact Name" value="{{ $lead_info->prospect_first_name .' '. $lead_info->prospect_last_name}}" >
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="designation" name='designation'class="form-control read-only-input" readonly placeholder="Enter Contact's Designation" value="{{ $lead_info->designation }}">
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="company_industry" name='company_industry'class="form-control" placeholder="Enter Industry" readonly value="{{ $lead_info->company_industry }}">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="contact_number_1" name='contact_number_1'class="form-control" placeholder="Enter Cell Number" readonly value="{{ $lead_info->contact_number_1 }}">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="prospect_email" name='prospect_email' class="form-control" placeholder="Enter Email" readonly value="{{ $lead_info->prospect_email }}">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group" id="company_desc_new">

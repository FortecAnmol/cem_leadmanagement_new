      ...
      @endif
         <div class="card card-outline-info">
            ...
            <div class="card-body lhs">
               <form method='post' action="{{ route('employee.lhs_report_save') }}">
                  @csrf
                  <div class="form-body ">
                     <div class="row p-t-20">
                        <div class="col-md-6">
                           <div class="form-group">
                              <input type="hidden" id="lead_id" name='lead_id'class="form-control" placeholder="NA" value="{{ $data->id}}">
                              <?php if(isset($_GET["status"])){  ?>
                               <input type="hidden" id="lead_status" name='status'class="form-control" placeholder="NA" value="{{ intval($_GET["status"])}}">
                               <?php } ?>
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="board_no" name='board_no' class="form-control form-control-danger disablePaste" placeholder="Enter Board Number" value="{{ old('board_no') }}">
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="designation" name='designation'class="form-control" readonly placeholder="Enter Contact's Designation" value="{{ $data->designation }}">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="direct_no" name='direct_no'class="form-control" placeholder="Enter Direct Number" value="{{ old('direct_no') }}">
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="company_name" name='company_name'class="form-control" readonly placeholder="Enter Company" value="{{ $data->company_name }}">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="ext_if_any" name='ext_if_any'class="form-control" placeholder="Enter Ext (if any)" value="{{ old('ext_if_any') }}">
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="company_industry" name='company_industry'class="form-control" placeholder="Enter Industry" readonly value="{{ $data->company_industry }}">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="contact_number_1" name='contact_number_1'class="form-control" placeholder="Enter Cell Number" readonly value="{{ $data->contact_number_1 }}">
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="employees_strength" name='employees_strength'class="form-control" placeholder="Enter Employees" value="{{ old('employees_strength') }}">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="prospect_email" name='prospect_email' class="form-control" placeholder="Enter Email" readonly value="{{ $data->prospect_email }}">
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="revenue" name='revenue'class="form-control" placeholder="Enter Revenue" value="{{ old('revenue') }}">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="ea_name" name='ea_name'class="form-control" placeholder="Enter EA Name" value="{{ old('ea_name') }}">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="ea_phone_no" name='ea_phone_no'class="form-control" placeholder="Enter EA Phone Number" value="{{  old('ea_phone_no') }}">
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="linkedin_address" name='linkedin_address'class="form-control" readonly placeholder="Enter EA LinkedIn Profile" value="{{ $data->linkedin_address }}">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="ea_email" name='ea_email' class="form-control" placeholder="Enter EA Email:" value="{{ old('ea_email') }}">
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="prospects_level" name='prospects_level'class="form-control" placeholder="Enter Prospect Level" value="{{ old('prospects_level') }}">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="website" name='website'class="form-control" placeholder="Enter Website" value="{{ old('website') }}">
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="prospect_vertical" name='prospect_vertical'class="form-control" placeholder="Enter Prospect Vertical" value="{{ old('prospect_vertical') }}">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="opt_in_status" name='opt_in_status'class="form-control" placeholder="Enter Opt-in Status" value="{{ old('opt_in_status') }}">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              <label class="control-label"></label>
                              <input type="text" id="influencers_decision_making_process" name='influencers_decision_making_process'class="form-control" placeholder="NA" value="{{ old('influencers_decision_making_process') }}">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              <label class="control-label"></label>
                              <input type="text" id="company_already_affiliated" name='company_already_affiliated'class="form-control" placeholder="NA" value="{{ old('company_already_affiliated') }}">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <select id="time_zone" required name='timezone_1' class="form-control" >
                                 ...
                                 <option vlaue={{ strtoupper($tzzlist[$i]) }}> {{ strtoupper($tzzlist[$i]) }}</option> 
                                 <?php $i++;?>
                                 @endforeach
                              </select>
                           </div>
